    ...
    , m_defaultFont(8)    
{
    ...
    m_actionRibbonMinimize = ribbonBar()->addAction(QIcon(":/Resources/ribbonMinimize.png"), tr("Minimize the Ribbon"), Qt::ToolButtonIconOnly);
...
RibbonStyle::Theme RibbonWindow::theme() const
{
    ...
    {
        //Q_ASSERT(false);
		return RibbonStyle::Theme::Office2013Gray;
...
void RibbonWindow::minimizationChanged(bool minimized)
{
    ...
    m_actionRibbonMinimize->setIcon(minimized ? QIcon(":/Resources/ribbonMaximize.png") :
        QIcon(":/Resources/ribbonMinimize.png"));
}
